...
namespace NaughtyAttributes.Editor
{
    ...
    public static class SpecialCaseDrawerAttributeExtensions
    {
        ...
        public static SpecialCasePropertyDrawerBase GetDrawer(this SpecialCaseDrawerAttribute attr) => _drawersByAttributeType.TryGetValue(attr.GetType(), out SpecialCasePropertyDrawerBase drawer) ? drawer : null;
    }
}
